...
export const NavigationButton = ( {title , link,count=true,width=130,height=48,color1='#C038F5',color2='#3496FE '}) =>{
    ...
    return(
       ...
       <Link href={link}><a href="">
           <div className={count ? styles.container : cs(styles.container2, route.asPath === link ? styles.a_active : null)} onMouseEnter={() => setActive(true)} onMouseLeave={() => setActive(false)}>
