...
export const OfferCard= ( {total,detail1,detail2,mainDetail,mainDetail2,price,title,img,data,id,active,setActive,busket,selector = true,...props }) =>{
    ...
    const handleClick =() =>{
        dispatch(setItemInCart({total,img,changedPrice,id,title,time,Priced,detail1,detail2,mainDetail,mainDetail2,selector}))
                    ...
                    <meta itemProp="price" content={changedPrice}/>
                        <meta itemProp="priceCurrency" content="RUB"/>
                            ...
                            <div className={styles.select}>
                                {selector === true ? <Selector changedPrice={changedPrice} setChangedPrice={setChangedPrice} price={price} setTime={setTime} time={time} check={check()}/> : null}
                    </div>
                    ...
                    <div className={cs(styles.busket,check() ? styles.busket_disabled : null)} onClick={check() ? null : handleClick} >
                        ...
                        { check() ?
                            ...
                            <div className={styles.bucket}  >
                                {background && size.width>720 ? <BlobCoverReverse classNames={styles.svg} width={51} height={40} color1="#C038F5" color2='#3496FE'/> : null}
