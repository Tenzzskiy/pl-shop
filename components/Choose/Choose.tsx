   ...
   return(
       ...
       <div className={styles.title}>
           ...
           {size.width > 720 ?
               ...
               <div>1. Тип вашего контента <br/>(презентация, фото, видео)</div>
               <div>2. Размер экрана, на который<br/> планируется трансляция </div>
               <div>3. Разрешение проектора<br/> (XGA, WXGA, FullHD) </div>
               </div> : null
