...
const Projectors = ({ cards }) => {
    ...
    return (
      <>
          <Layout >
              ...
              <MediumHeaderComponent
                  ...
                  mainImg="/Hero Blocks/newProjectorsHero1920.jpg"
                  img_360='/Hero Blocks/newProjectorsHero360.jpg'
                  setSites={setSites}
     ...
     <Offer data={cards.projectorAdditionals} active={modalActive} setActive={setModalActive} count={3}/>
              ...
              text1=' Компания предлагает взять в аренду на мероприятие проектор с доставкой. Всегда в наличии широкий выбор профессионального оборудования для проведения конференции, выставки, праздника или инсталляции любого формата. Заказчикам гарантируется гибкая стоимость услуг, монтаж, настройка и демонтаж под ключ.
...
организация видеоигры на большом экране;В
