    ...
    <Layout>
        ...
        {size.width < 1200 && size.width > 720 ?
            ...
            и корпоративных мероприятий с 2007 года и точно знаем своё дело!'
                ...
                rightText='В зависимости от задач мы подберем для вас плазму
            либо соберем видеостену, либо смонтируем масштабную светодиодную сцену!'
                rightSecondText='Возьмём на себя все вопросы по инсталляции и избавим вас от
            головной боли! Монтаж и демонтаж уже включены в стоимость!'
                rightTitle='Огромный выбор'
                rightSecondTitle='Под ключ'
            /> : null
...
Высокое качество изображения достигается благодаря использованию только современной аппаратуры, а также грамотной настройке с учетом формата встречи, особенностей зала, где будет транслироваться видео. Заказывая услуги по аренде,
клиент получает полный спектр услуг для проведения праздника. Специалисты привезут оборудование, заранее осуществят монтаж.
          '
